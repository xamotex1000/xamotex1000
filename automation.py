...
|-|-|
|<img src="https://img.shields.io/badge/JavaScript%20-%20%230050b1?style=flat&logo=Node.js" height=32></img>|{ config.get('js') }/10, { config.get('js text') }|
|<img src="https://img.shields.io/badge/C%20Sharp%20%20%20-%20%230050b1?style=flat&logo=C%23&logoColor=%23900090" alt="C#" height=32></img>|{ config.get('c#') }/10, { config.get('c# text') }|
|<img src="https://img.shields.io/badge/Python%20-%20%230050b1?style=flat&logo=Python&logoColor=%23ffff00" alt="Python" height=32></img>|{ config.get('py') }/10, { config.get('py text') }|
|<img src="https://img.shields.io/badge/GNU%20Bash%20-%20%230050b1?style=flat&logo=GNU%20Bash" alt="Bash" height=32></img>|{ config.get('bash') }/10, { config.get('bash text') }|
|<img src="https://img.shields.io/badge/C%20-%20%230050b1?style=flat&logo=C" alt="C" height=32></img>|{ config.get('c') }/10, { config.get('c text') }|
|<img src="https://img.shields.io/badge/PHP%20-%20%230050b1?style=flat&logo=Php&logoColor=%23000090" alt="PHP" height=32></img>|{ config.get('php') }/10, { config.get('php text') }|
...
![xamotex1000's GitHub Stats](https://github-readme-stats.vercel.app/api?username={stats.username}&theme={stats.theme}&show_icons={stats.show_icons}&hide_border={stats.hide_border}&count_private={stats.count_private})
'''
